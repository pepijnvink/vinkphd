...
RcppExport SEXP _vinkphd_cat_mult_fw_cpp(SEXP allprobsSEXP, SEXP gammaSEXP, SEXP mSEXP, SEXP nSEXP, SEXP deltaSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_vinkphd_cat_mult_fw_cpp", (DL_FUNC) &_vinkphd_cat_mult_fw_cpp, 5},
    {NULL, NULL, 0}
};

RcppExport void R_init_vinkphd(DllInfo *dll) {
